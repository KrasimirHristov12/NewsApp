...
namespace NewsApp.Data.Migrations
{
    ...
    [Migration("20230126132719_AddPathColumnInImages")]
    partial class AddPathColumnInImages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsApp.Data.Models.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NewsApp.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NewsApp.Data.Models.Article", b =>
                {
                    b.HasOne("NewsApp.Data.Models.Category", "Category")
                        .WithMany("Articles")
